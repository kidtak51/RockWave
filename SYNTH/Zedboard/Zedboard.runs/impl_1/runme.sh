...
HD_PWD='/home/aokim/RockWave/SYNTH/Zedboard/Zedboard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_zedboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_zedboard.tcl -notrace

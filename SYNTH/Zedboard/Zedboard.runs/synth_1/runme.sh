...
HD_PWD='/home/aokim/RockWave/SYNTH/Zedboard/Zedboard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_zedboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_zedboard.tcl
